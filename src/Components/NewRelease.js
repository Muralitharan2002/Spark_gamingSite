...
function NewRelease() {
    return (
        ...
        <div className='bg-black flex items-center justify-center lg:flex-nowrap flex-wrap lg:px-12 px-3 lg:gap-7 md:gap-10 gap-10 py-40 -mt-1'>
            <div className=' space-y-4 lg:flex-1 lg:w-1/3 md:w-full'>
